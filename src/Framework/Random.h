...
namespace Engine
{
	...
	public:
		...
		template <class ValueType, typename enable_if_t<is_integral_v<ValueType>> * = 0>
		...
		template <class ValueType, typename enable_if_t<is_floating_point_v<ValueType>> * = 0>
		ValueType Get(ValueType _min, ValueType _max)
		{
		...
		template <class ValueType, class = typename enable_if_t<is_floating_point_v<ValueType>>>
